...
@FFITypeAlias("llvm::VectorType")
public interface VectorType extends Type {
    static boolean isa(Type type) {
        return TypeCasting.INSTANCE.isa(type, (VectorType) null);
    }

    static VectorType cast(Type type) {
        return TypeCasting.INSTANCE.cast(type, (VectorType) null);
    }
