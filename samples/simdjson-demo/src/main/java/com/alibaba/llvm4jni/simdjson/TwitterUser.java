...
@FFIGen
@FFITypeAlias("simdjson::twitter_user")
@CXXHead("benchmarks.h")
@CXXTemplate(cxx = "std::string_view", java = "com.alibaba.llvm4jni.simdjson.stdcxx.StringView")
public interface TwitterUser<T> extends CXXPointer {

    Factory<StringView> STRING_VIEW_FACTORY = FFITypeFactory.getFactory(TwitterUser.class, "simdjson::twitter_user<std::string_view>");

    @FFIFactory
    interface Factory<T> {
        TwitterUser<T> create();
    }
